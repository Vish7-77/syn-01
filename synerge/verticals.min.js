...
window.jwplayer = (function (t) {
  ...
  function (t, e, n) {
    ...
    var i = function () {
      ...
      h = function () {
        return (
          r(/\s(?:(?:Headless)?Chrome|CriOS)\//i) && !l() && !r(/UCBrowser/i)
        );
      },
      v = function () {
  ...
  function (t, e, n) {
    ...
    function p(t) {
      for (
        var e = t.querySelectorAll("script,object,iframe,meta"), n = e.length;
        n--;
    ...
    function d(t) {
      ...
      var r =
        ...
        o =
          i.Browser.safari &&
          (!c.a.canPlayType ||
            !c.a.canPlayType("application/vnd.apple.mpegURL")),
  ...
  function (t, e, n) {
    ...
    var r = n(29),
      ...
      u = function () {
        var t = "//ssl.p.jwpcdn.com/player/v/8.23.1/";
  ...
  function (t, e, n) {
    ...
    e.a = function (t) {
      ...
      var e = Object(r.j)(
        {},
        { sources: [], tracks: [], minDvrWindow: a.b },
        t
      );
  ...
  function (t, e, n) {
    ...
    var r =
      "8.23.1+commercial_v8-23-1.476.commercial.1d2aad6.hlsjs..hlsjsalt..jwplayer.e48cc6a.dai.1f98a0b.freewheel.20bc668.googima.b98d228.googimanvmp.106f6b4.headerbidding.ec72a89.vast.9d030c5.analytics.d52963c.analyticskraken.5483d88.gapro.141397a";
  },
  function (t, e, n) {
    "use strict";
    var r = n(0),
  ...
  function (t, e, n) {
          ...
          o = function (e) {
            if (t.dragged) T(t, i.s, e);
              ...
              var r = E(e),
                ...
                c = u - t.startY;
              a * a + c * c > 36 &&
                (T(t, i.u, e), (t.dragged = !0), T(t, i.s, e));
            }
            var s;
            n ||
              "touchmove" !== e.type ||
          ...
          u = function (e) {
            clearTimeout(s),
              t.el &&
                (x(t),
                P(t, "window"),
                t.dragged && ((t.dragged = !1), T(t, i.t, e)));
          };
        w(t, "init"),
          _(
            t,
              ...
              if ((Object(a.p)(e, "jw-tab-focus"), !A(i))) {
                ...
                if (!t.directSelect || c === e) {
                  ...
                  if (
                    ...
                    "mousedown" === s
                      ? (C(t, "window", "mousemove", o, r),
                        C(t, "window", "mouseup", u))
                      : "touchstart" === s &&
    ...
    function j(t) {
      if (!t.handlers.select) {
        var e = t.el;
        w(t, "select"),
          _(t, "select", function (n) {
            var r = n.target;
            A(n) ||
              (t.directSelect && r !== e) ||
              (n.isPrimary && "BUTTON" === r.tageName && r.focus(),
      ...
      if (
        ...
        C(t, e, "blur", function () {
          ...
          C(t, e, "focus", function () {
            l.event &&
              "keydown" === l.event.type &&
              Object(a.b)(n, "jw-tab-focus");
          });
      }
    }
    var O = {
    ...
    function _(t, e, n, r) {
      d
        ? C(t, e, "pointerdown", n, r)
        : (p && C(t, e, "mousedown", n, r), C(t, e, "touchstart", n, r));
    }
  },
  function (t, e, n) {
    "use strict";
  ...
  function (t, e, n) {
    ...
    function Z(t, e) {
      var n = {
        reason:
          !("play" === t || "seek" === t || "pause" === t) && Object(W.a)()
            ? "interaction"
            : "external",
      };
      switch (t) {
  ...
  function (t, e, n) {
            ...
            var e = t.get("controls"),
              ...
              i = (function (t, e) {
                ...
                if (Array.isArray(n) && n.length)
                  for (
                    var r = Object(c.f)(t.get("item"), n.length),
                      i = Object(c.c)(Object(a.a)(n[r]), t),
                      o = 0;
                    o < i.length;
                    o++
                  )
                ...
                (o = n
                  ...
                  .then(
                    function (t) {
                      ...
                      var e = n(72).default;
                      return (
                        (f.a.controls = n(70).default),
                        Object(l.a)(n(294).default),
                        e
                      );
                    }.bind(null, n)
                  )
                  .catch(Object(u.b)(d.s + 105))),
                (u.a.html5 = o),
                o
              );
            var o;
    ...
    function T(t) {
      return F(t)
        ...
        : k(t)
            .then(function () {
              if (t.get("drm") || Object(x.b)(t.get("playlist")))
                return Object(x.d)(t.get("edition"));
            })
            .then(function () {
    ...
    function A(t, e) {
      ...
      return window.location !== window.parent.location &&
        /isAMP/.test(document.location.search)
        ? (function (t, e) {
            return (function (t, e) {
              return n
                .e(1)
    ...
    function _(t) {
      ...
      if (n && n.code === S.a) {
        ...
        if (i > 0 && i < 4 && r && o.duration() > -7776e6)
          return new j.a("//content.jwplatform.com/libraries/" + r + ".js")
            .load()
            .then(function () {
    ...
    var I = function (t) {
      ...
      M = function (t) {
        var e = t.attributes,
          ...
          o = e.intl,
          u = Object(w.c)(i, o, n);
        return !Object(w.h)(n) || Object(w.f)(u)
          ? Promise.resolve()
          : new Promise(function (i) {
              return Object(w.i)(r, n)
                .then(function (n) {
                  var r = n.response;
                  if (!P(t)) {
          ...
          (e.getAllItems = function () {
            ...
            return this.items.reduce(function (e, n) {
              ...
              return (
                r &&
                  (e[n] =
                    "captions" !== n ? Object(D.serialize)(r) : JSON.parse(r)),
                e
              );
            }, {});
          }),
    ...
    var $ = function (t) {
      (this._events = {}),
        (this.modelShim = new V.a()),
        (this.modelShim._qoeItem = new R.a()),
        (this.mediaShim = {}),
    ...
    function J(t, e) {
      e &&
        ...
        console.error(d.q.logMessage(e.code)));
    }
    function K(t) {
    ...
    Object(r.j)($.prototype, {
      ...
      init: function (t, e) {
        ...
        i.get("backgroundLoading") ||
          (l = Object(X.a)(l.getPrimedElement(), l));
        var f = (this.primeUi = new Y.a(
          Object(Y.b)(this.originalContainer)
                    ...
                    if (!o) {
                      ...
                      Q.a.cloneIcon &&
                        u
                          ...
                          .appendChild(Q.a.cloneIcon("error")),
                        Z(t, u);
                    }
                    i.set("errorEvent", r),
                      i.set("state", b.lb),
    ...
    function g(t, e) {
      var n = "file:" === window.location.protocol ? "https:" : "",
        r = {
          ...
          googima: e
            ? "//ssl.p.jwpcdn.com/player/v/8.23.1/googimanvmp.js"
            : "//ssl.p.jwpcdn.com/player/plugins/googima/v/8.9.1/googima.js",
          freewheel:
            "//ssl.p.jwpcdn.com/player/plugins/freewheel/v/2.2.16/freewheel.js",
      ...
      for (var i = 0; i < videoDiv.length; i++) {
        if (videoDiv[i].parentElement.classList.contains("active")) {
          if (el.classList.contains("activePause")) {
            if (
              jwplayer(videoDiv[i]).getState() == "playing" ||
              jwplayer(videoDiv[i]).getState() == "buffering"
            ) {
            ...
            if (
              jwplayer(videoDiv[i]).getState() == "idle" ||
              jwplayer(videoDiv[i]).getState() == "stop" ||
              jwplayer(videoDiv[i]).getState() == "paused"
            ) {
...
CarousalComp.prototype = {
  init: function (self) {
        ...
        if (window.innerWidth > 991) {
          ...
          if (isSafari) {
            jwplayer(videoDiv[0].id).on("time", function () {
              ...
              var widthPr = percent;
              if (
                videoDiv[0].previousElementSibling.classList.contains(
                  "videoSeekBar"
                )
              ) {
    ...
    if (self.el.querySelectorAll(".carItemParent").length != 0) {
      ...
      self.linkschild = self.el.querySelectorAll(
        ".navDivChild.navDivRedirect a"
      );
      ...
      if (
        self.el.closest("section").getElementsByClassName("backImgD").length !=
        0
      ) {
        self.el
          .closest("section")
          .getElementsByClassName("backImgD")[0]
          .children[0].setAttribute(
            "src",
            self.el
              .querySelectorAll(".carItemParent.active")[0]
              .getElementsByClassName("backImg")[0]
              .getAttribute("src")
          );
        self.el
          .closest("section")
          .getElementsByClassName("backImgD")[0]
          .children[0].classList.add("setBack");
      }
    } else {
  ...
  addPrevAndNext: function (elems, self) {
    ...
    if (elems.length != 0) {
      elems[arrLink[0]].addEventListener(
        "click",
        function () {
      ...
      elems[arrLink[1]].addEventListener(
        "click",
        function () {
          self.stopImgTimer(self);
  ...
  playPauseTimer: function (self) {
    ...
    if (elem.length != 0) {
      for (var i = 0; i < elem[0].children.length; i++) {
        ...
        } else elem[0].children[i].classList.add("noDisplay");
      }
    }
  },
  ...
  slideImage: function (
    ...
    if (self.el.classList.contains("heroCarousel")) {
      if (self.intervalCarousel != parseInt(18000)) {
        self.intervalCarousel = parseInt(18000);
      }
      stopSlide(
        findSlidingElem(
          elemList[0].parentElement.parentElement.parentElement.getElementsByClassName(
            "carouselDiv"
          )
        )
      );
    ...
    if (elemList[nextIndex].classList.contains("carItemParent")) {
      self.removeActive(
        elemList[nextIndex].getElementsByClassName("carItem"),
        ""
      );

      elemList[nextIndex].getElementsByClassName("carItem")[0].className =
        "carItem carItemChild active";
    }
    setTimeout(function () {
      ...
      if (elemList[nextIndex].classList.contains("carItemParent")) {
        elemList[nextIndex]
          .closest("section")
          .getElementsByClassName("backImgD")[0]
          .children[0].classList.remove("setBack");
        elemList[nextIndex]
          .closest("section")
          .getElementsByClassName("backImgD")[0]
          .children[0].setAttribute(
      ...
      setTimeout(function () {
        ...
        if (elemList[nextIndex].classList.contains("carItemParent")) {
          ...
          if (
            elemList[nextIndex].getElementsByClassName("carouselIndicators")
              .length != 0
          ) {
            self.removeActive(
              elemList[nextIndex].getElementsByClassName(
                "carouselIndicators"
              )[0].children,
              "list"
            );
            elemList[nextIndex]
              .getElementsByClassName("carouselIndicators")[0]
              .children[0].classList.add("active");
          }
        } else if (elemList[nextIndex].classList.contains("carItemChild"))
          elemList[nextIndex].className = "carItem carItemChild active";
        else elemList[nextIndex].className = "carItem active";
        var itemsActivated = elemList[nextIndex].children;
        var playPauseBtn =
          document.getElementsByClassName("centerIndicator")[0];

        //code for onSlide video on homepage controls + seekbar
        if (window.innerWidth > 767) {
          if (
            self.intervalCarousel != 18000 &&
            self.el.classList.contains("heroCarousel")
          ) {
            self.intervalCarousel = 18000;
          }
          var videoDivs = document.querySelectorAll(".carouselDiv .jwplayer");
          if (videoDivs.length != 0) {
            for (var j = 0; j < videoDivs.length; j++) {
              if (
                !(
                  videoDivs[j].parentElement.classList.contains("active") ||
                  videoDivs[j].parentElement.parentElement.classList.contains(
                    "active"
                  )
                )
              ) {
          ...
          for (var i = 0; i < itemsActivated.length; i++) {
            if (itemsActivated[i].classList.contains("jwplayer")) {
              ...
              if (
                videoTag.previousElementSibling.classList.contains(
                  "videoSeekBar"
                )
              ) {
              ...
              if (!playPauseBtn.classList.contains("activePause")) {
                if (
                  jwplayer(videoTag).getState() == "idle" ||
                  jwplayer(videoTag).getState() == "stop" ||
                  jwplayer(videoTag).getState() == "paused"
                ) {
        ...
        if (
          elemList[nextIndex].parentNode.parentNode.getElementsByClassName(
            "carouselIndicators"
          ).length != 0
        ) {
          self.removeActive(
          ...
          elemList[nextIndex].parentNode.parentNode
            .getElementsByClassName("carouselIndicators")[0]
    ...
    if (elemList.length != 0) {
      if (paramL != "list") {
        for (var i = 0; i < elemList.length; i++) {
          ...
          else if (elemList[i].classList.contains("carItemChild")) {
          } else elemList[i].className = "carItem";
        }
      } else {
        for (var i = 0; i < elemList.length; i++) {
  ...
  stopImgTimer: function (self) {
    if (
      self.intervalCarousel != 0 &&
      self.el.getElementsByClassName("carItem").length > 1
    ) {
    ...
    if (self.el.querySelectorAll(".carItemParent").length != 0) {
      if (self.intervalCarousel != 0) {
        ...
        self.switching = setInterval(function () {
          var elems = self.el
            .querySelectorAll(".carItemParent.active")[0]
            .getElementsByClassName("carItemChild");
          for (i = 0; i < elems.length; i++) {
            if (elems[i].classList.contains("active")) break;
          }
          if (i == elems.length - 1) {
            self.changeImageCar(false, self, false, "");
          } else self.changeImageCar(false, self, true, self.el.querySelectorAll(".carItemParent.active")[0]);
      ...
      if (
        ...
        self.switching = setInterval(function () {
          if (self.el.classList.contains("heroCarousel")) {
            if (
              !document
                .querySelector(".heroControlsArrow .centerIndicator")
                .classList.contains("activePause")
            ) {
  ...
  setVisable: function (self) {
    if (self.el.getElementsByClassName("carItemParent").length != 0) {
      ...
      } else var elem = self.el;
      self.setSlideNumber(
        elem,
        self.el.getElementsByClassName("carItemParent"),
        self
      );
      ...
      if (self.el.getElementsByClassName("carItemParent")[0] != undefined) {
        if (
          self.el
            .querySelectorAll(".carItemParent.active")[0]
            .getElementsByClassName("carItemChild").length != 0
        ) {
          self.setSlideNumber(
            self.el
              .querySelectorAll(".carItemParent.active")[0]
              .getElementsByClassName("carIndicators")[0],
            self.el
              .querySelectorAll(".carItemParent.active")[0]
              .getElementsByClassName("carItemChild"),
            self
      ...
      self.setSlideNumber(
        self.el,
        self.el.getElementsByClassName("carItem"),
        self
      );
    }
  },
  ...
  setSlideNumber: function (elem, dataElem, self) {
    if (elem.getElementsByClassName("slideNumber").length != 0) {
      ...
      if (elem.getElementsByClassName("totalSlide").length != 0) {
        ...
        elem.getElementsByClassName("totalSlide")[0].innerHTML =
          dataElem.length;
      } else {
        elem.getElementsByClassName("slideNumber")[0].innerHTML =
          visibleElem + " / " + dataElem.length;
      }
    }
    if (window.innerWidth < 992) {
      if (
        self.el.classList.contains("brandCarousel") &&
        self.indicators != undefined
      ) {
        for (var i = 0; i < self.indicators.length; i++) {
          var getAttr = self.indicators[i].getAttribute("data-slide-to");
          if (
            self.indicators[i].classList.contains("forBrands") &&
            self.indicators[i].classList.contains("active")
          ) {
            if (
              self.indicators[i].getBoundingClientRect().left >
                window.innerWidth - self.indicators[i].offsetHeight &&
              self.indicators[i].classList.contains("forBrands")
            ) {
              brandsThumbnail[0].scrollBy(
                0,
                window.innerWidth - self.indicators[i].offsetWidth
              );
            }
            if (
              self.indicators[i].getBoundingClientRect().left < 0 &&
              self.indicators[i].classList.contains("forBrands")
            ) {
              brandsThumbnail[0].scrollBy(
                0,
            ...
            if (getAttr == "0") {
              brandsThumbnail[0].scrollBy(
                0,
                -(self.indicators[0].offsetWidth * self.indicators.length)
              );
            }
      ...
      for (var i = 0; i < indicators.length; i++) {
        indicators[i].addEventListener("click", function (event) {
          ...
          if (
            event.currentTarget
              .closest(".carouselDiv")
              .getElementsByClassName("carItem")[0]
              .classList.contains("carItemChild")
          ) {
            elem = event.currentTarget.closest(".carItem");
            self.stopImgTimer(self);
            self.changeElem(
              parseInt(event.currentTarget.getAttribute("data-slide-to")),
              self,
              elem
            );
            self.startImgTimer(self);
  ...
  changeElem: function (elemIndex, self, elem) {
    if (elem == "") var dataElem = self.el.getElementsByClassName("carItem");
    else dataElem = elem.getElementsByClassName("carItem");
    var elemIdVisible = self.searchVisibleElem(dataElem);
  ...
  initElement: function (self) {
    ...
    self.slideImage(
      dataElem,
      self.searchVisibleElem(dataElem),
      0,
      "next",
      "left",
      self
...
document
  .getElementsByClassName("globalSearchIcon")[0]
...
if (
  ...
  document.querySelector(".parallaxControlsStory")
) {
  var maxHeightParallax = document.querySelector(
    ".parallaxControlsStory"
  ).scrollHeight;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  for (
    var i = 0;
    i < document.getElementsByClassName("heroCarousel").length;
    i++
  ) {
    sliderObj[sliderObj.length] = new CarousalComp(
      document.getElementsByClassName("heroCarousel")[i],
      18000
    );
  }
  for (
    var i = 0;
    i < document.getElementsByClassName("commCarousel").length;
    i++
  ) {
    sliderObj[sliderObj.length] = new CarousalComp(
      document.getElementsByClassName("commCarousel")[i],
      15000
    );
  }
  for (
    var i = 0;
    i < document.getElementsByClassName("imgCarousel").length;
    i++
  ) {
    sliderObj[sliderObj.length] = new CarousalComp(
      document.getElementsByClassName("imgCarousel")[i],
      7000
    );
  }
  for (
    var i = 0;
    i < document.getElementsByClassName("twitter-carousel").length;
    i++
  ) {
    sliderObj[sliderObj.length] = new CarousalComp(
      document.getElementsByClassName("twitter-carousel")[i],
      7000
    );
  }
  for (
    var i = 0;
    i < document.getElementsByClassName("jobsCarouselHome").length;
    i++
  ) {
    sliderObj[sliderObj.length] = new CarousalComp(
      document.getElementsByClassName("jobsCarouselHome")[i],
      7000
    );
  }
  for (
    var i = 0;
    i < document.getElementsByClassName("storyCarousel").length;
    i++
  ) {
    sliderObj[sliderObj.length] = new CarousalComp(
      document.getElementsByClassName("storyCarousel")[i],
      7000
    );
  }
  for (
    var i = 0;
    i < document.getElementsByClassName("holdingsCarousel").length;
    i++
  ) {
    sliderObj[sliderObj.length] = new CarousalComp(
      document.getElementsByClassName("holdingsCarousel")[i],
      7000
    );
  }
  for (
    var i = 0;
    i < document.getElementsByClassName("careerCarousel").length;
    i++
  ) {
    sliderObj[sliderObj.length] = new CarousalComp(
      document.getElementsByClassName("careerCarousel")[i],
      7000
    );
  }
  for (
    var i = 0;
    i < document.getElementsByClassName("jobs-carousel").length;
    i++
  ) {
    sliderObj[sliderObj.length] = new CarousalComp(
      document.getElementsByClassName("jobs-carousel")[i],
      7000
    );
  }
  if (window.innerWidth > 576) {
    for (
      var i = 0;
      i < document.getElementsByClassName("brandsCrousel").length;
      i++
    ) {
      sliderObj[sliderObj.length] = new CarousalComp(
        document.getElementsByClassName("brandsCrousel")[i],
        10000
      );
    }
  }
  for (
    var i = 0;
    i < document.getElementsByClassName("brandCarousel").length;
    i++
  ) {
    sliderObj[sliderObj.length] = new CarousalComp(
      document.getElementsByClassName("brandCarousel")[i],
      10000
    );
  }
...
function animateCard(partial, moduleCard) {
  ...
  var animTop =
    moduleCard.getBoundingClientRect().top + document.documentElement.scrollTop;
...
window.addEventListener("load", function (event) {
  if (document.getElementsByClassName("twitterMentions").length === 0) {
    ...
    var tweeterMentionJoblanding =
      document.getElementsByClassName("jobcareers");
    if (tweeterMention.length > 0) {
      ...
      xhttpTwitterMention.onload = function () {
        if (
          xhttpTwitterMention.readyState == 4 &&
          xhttpTwitterMention.status === 200
        ) {
          for (var j = 0; j < tweeterMention.length; j++) {
            if (tweeterMention[j].classList.value == "careers") {
              var temp = JSON.parse(
                JSON.parse(xhttpTwitterMention.response).response
              );
              ...
              console.log(
                "Request failed.  Returned status of " + xhttp.status
              );
            }
          }
          numberAnim("active");
      ...
      xhttpTwitterMention.onload = function () {
        if (
          ...
          if (
            tweeterMentionJoblanding[0].getAttribute(
              "data-usedynamicjobcountcard1"
            ) == "true"
          ) {
          ...
          if (
            tweeterMentionJoblanding[1].getAttribute(
              "data-usedynamicjobcountcard2"
            ) == "true"
          ) {
          ...
          if (
            tweeterMentionJoblanding[2].getAttribute(
              "data-usedynamicjobcountcard3"
            ) == "true"
          ) {
...
function numberAnim(postion) {
  ...
  for (var i = 0; i < moduleCard.length; i++) {
    if (animateCard(true, moduleCard[i])) {
      moduleCard[i].classList.add("come-in");
      if (
        moduleCard[i].getElementsByClassName("startAnim").length != 0 &&
        animFlag &&
        animationFlag[i] &&
        moduleCard[i].getBoundingClientRect().top < window.innerHeight
      ) {
        moduleCard[i]
          .getElementsByClassName("startAnim")[0]
          .classList.add("jobFigures");
        if (moduleCard[i].getElementsByClassName("startAnim").length == 2)
          moduleCard[i]
            .getElementsByClassName("startAnim")[1]
            .classList.add("jobFigures2");
        var valFromHtml =
          moduleCard[i].getElementsByClassName("jobFigures")[0].innerText;
        if (moduleCard[i].getElementsByClassName("jobFigures2")[0])
          var valFromHtml2 =
            moduleCard[i].getElementsByClassName("jobFigures2")[0].innerText;
        ...
        if (animationFlag[i]) animationCount++;
...
function animateLine(partial, borderAnimCards) {
  ...
  var viewBtm = viewTop + document.documentElement.clientHeight;
  var animTop =
    borderAnimCards.getBoundingClientRect().top +
...
for (var i = 0; i < managementInfo.length; i++) {
  ...
  if (len >= 135) {
    managementInfo[i].innerHTML =
      managementInfo[i].innerHTML.substring(0, 135) + "...";
  }
}
for (var i = 0; i < feedsTwitter.length; i++) {
  if ((feedsTwitter[i].className = "feedsTwitter")) {
    ...
    if (len >= 255) {
      feedsTwitter[i].innerHTML =
        feedsTwitter[i].innerHTML.substring(0, 255) + "...";
    }
  }
}
...
var ymlArticleincW = document.getElementsByClassName(
  "ymlFeedArticleW incWidth"
);
...
for (var i = 0; i < infoFeedArticle.length; i++) {
  if (infoFeedArticle[i].className == "infoFeedArticle") {
    ...
    if (len >= 360) {
      infoFeedArticle[i].innerHTML =
        infoFeedArticle[i].innerHTML.substring(0, 360) + "...";
    }
  }
}
  ...
  if (companyFeedArticle[i].className == "companyFeedArticle") {
    ...
    if (len >= 420) {
      if (window.innerWidth > 991 || window.innerWidth < 576) {
        companyFeedArticle[i].innerHTML =
          companyFeedArticle[i].innerHTML.substring(0, 650) + "...";
      } else {
        companyFeedArticle[i].innerHTML =
          companyFeedArticle[i].innerHTML.substring(0, 450) + "...";
      }
    }
  }
}
...
for (var i = 0; i < ymlArticle.length; i++) {
  if (ymlArticle[i].className == "ymlFeedArticle") {
    var len = ymlArticle[i].innerHTML.length;
    if (len >= 90) {
      ymlArticle[i].innerHTML =
        ymlArticle[i].innerHTML.substring(0, 90) + "...";
    }
  }
}
for (var i = 0; i < ymlTextArticle.length; i++) {
  if (ymlTextArticle[i].className == "ymlTextArticle") {
    ...
    if (len >= 90) {
      ymlTextArticle[i].innerHTML =
        ymlTextArticle[i].innerHTML.substring(0, 90) + "...";
    }
  }
}
for (var i = 0; i < ymlArticleincW.length; i++) {
  if (ymlArticleincW[i].className == "ymlFeedArticleW incWidth") {
    ...
    if (len >= 90) {
      ymlArticleincW[i].innerHTML =
        ymlArticleincW[i].innerHTML.substring(0, 90) + "...";
    }
  }
}
...
for (var i = 0; i < ymlArticleW.length; i++) {
  if (ymlArticleW[i].className == "ymlFeedArticleW") {
    ...
    if (len >= 90) {
      ymlArticleW[i].innerHTML =
        ymlArticleW[i].innerHTML.substring(0, 90) + "...";
    }
  }
}
    ...
    if (fb[i]) {
      ...
      function chngImgColorfb() {
        this.style.backgroundImage =
          "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/common/shareOptions/color/FB.svg)";
      }
      fb[i].addEventListener("mouseleave", chngImgfb);

      function chngImgfb() {
        this.style.backgroundImage =
          "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/common/shareOptions/FB.svg)";
      }
    }
    if (twitter[i]) {
      ...
      function chngImgColortwitter() {
        this.style.backgroundImage =
          "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/common/shareOptions/color/twitter_icon.svg)";
      }
      twitter[i].addEventListener("mouseleave", chngImgtwitter);

      function chngImgtwitter() {
        this.style.backgroundImage =
          "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/common/shareOptions/twitter_icon.svg)";
      }
    }
    if (linkedin[i]) {
      ...
      function chngImgColorlinkedin() {
        this.style.backgroundImage =
          "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/common/shareOptions/color/LinkedIn.svg)";
      }
      linkedin[i].addEventListener("mouseleave", chngImglinkedin);

      function chngImglinkedin() {
        this.style.backgroundImage =
          "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/common/shareOptions/LinkedIn.svg)";
      }
    }
    if (mailto[i]) {
      ...
      function chngImgColormailto() {
        this.style.backgroundImage =
          "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/common/shareOptions/color/Contact_Us.svg)";
      }
      mailto[i].addEventListener("mouseleave", chngImgmailto);

      function chngImgmailto() {
        this.style.backgroundImage =
          "url(/etc.clientlibs/tata/clientlibs/assets/resources/img/common/shareOptions/Contact_Us.svg)";
      }
    }
...
function shareLabels() {
  if (window.innerWidth < 767) {
    var parallaxControls = document.querySelectorAll(
      ".forStoryPages > .parallaxControls"
    )[0];
    if (parallaxControls) {
...
var heroArrow = document.querySelectorAll(
  ".heroControlsArrow > .carousel-control"
);
window.addEventListener(
  "resize",
  function () {
...
var excelPath = "";
var URLCommon =
  urlFacts + "excelPath=" + excelPath + "&excelSheet=" + sheetName;
var elemColor;
...
function firstLoad(factsParentIndex, factCard) {
  ...
  xhttp.onload = function () {
    //setting data to html on first time load
    if (xhttp.readyState == 4 && xhttp.status === 200) {
      var elemHeriToChange = factsParent[factsParentIndex].querySelectorAll(
        ".heritageBG .titleContent"
      );
      var elementToChange = factsParent[factsParentIndex].querySelectorAll(
        ".changeBG .titleContent"
      );
      var facts = factsParent[factsParentIndex].querySelectorAll(
        ".facts .ymlFeedArticleW"
      );
      var factsLabel =
        factsParent[factsParentIndex].querySelectorAll(".facts .urlLabel");
      var nextFeed =
        factsParent[factsParentIndex].querySelectorAll(".nextFeed");
      ...
      if (facts) {
        ...
        for (var i = 0; i < nextFeed.length; i++) {
          ...
          if (res.response.url == "NA" || res.response.url == "na") {
            //if url is NA/na in excel
...
function refreshTextImg(e) {
  ...
  xhttpFacts.onreadystatechange = function () {
    //change data on individual card click
    if (xhttpFacts.readyState == 4 && xhttpFacts.status === 200) {
      ...
      if (jsonParse.response.url == "NA" || jsonParse.response.url == "na") {
        //if url is NA/na in excel
...
if (mainpara.length != 0) {
  ...
  if (hasDblQuote(splitText[0]) == true && hasNumber(splitText[0]) == true) {
    ...
    if (splitAfterDbl[0] == "<i>") {
      document.getElementsByClassName("mainActive")[0].innerHTML =
        `<span style="float: left;">` +
        "“" +
        `</span><span style="float: left;font-size: 72px;line-height: 58px;padding-top: 4px;padding-right: 8px;"><i>` +
        splitAfterDbl[1] +
        `</span>` +
        splitText[1];
      if (window.innerWidth < 575) {
        document.getElementsByClassName("mainActive")[0].innerHTML =
          `<span style="float: left;">` +
          "“" +
          `</span><span style="float: left;font-size: 52px;line-height: 40px;padding-top: 4px;padding-right: 8px; font-weight: normal"><i>` +
          splitAfterDbl[1] +
          `</span>` +
          splitText[1];
        ...
        document.getElementsByClassName("mainActive")[0].innerHTML =
          `<span style="float: left;">` +
          "“" +
          `</span><span style="float: left;font-size: 70px;line-height: 55px;padding-top: 4px;padding-right: 8px; font-weight: normal"><i>` +
          splitAfterDbl[1] +
          `</span>` +
          splitText[1];
      }
      ...
      document.getElementsByClassName("mainActive")[0].innerHTML =
        `<span style="float: left;">` +
        "“" +
        `</span><span style="float: left;font-size: 72px;line-height: 58px;padding-top: 4px;padding-right: 8px;">` +
        splitAfterDbl[1] +
        `</span>` +
        splitText[1];
      if (window.innerWidth < 575) {
        document.getElementsByClassName("mainActive")[0].innerHTML =
          `<span style="float: left;">` +
          "“" +
          `</span><span style="float: left;font-size: 52px;line-height: 40px;padding-top: 4px;padding-right: 8px; font-weight: normal">` +
          splitAfterDbl[1] +
          `</span>` +
          splitText[1];
      } else if (window.innerWidth > 767 && window.innerWidth < 991) {
        document.getElementsByClassName("mainActive")[0].innerHTML =
          `<span style="float: left;">` +
          "“" +
          `</span><span style="float: left;font-size: 70px;line-height: 55px;padding-top: 4px;padding-right: 8px; font-weight: normal">` +
          splitAfterDbl[1] +
          `</span>` +
          splitText[1];
      }
    ...
    hasSingleQuote(splitText[0]) == true &&
    hasNumber(splitText[0]) == true
  ) {
    var splitAfterDbl = splitText[0].split(/["\‘\'"]+/);
    mainpara[0].classList.add("mainActive");
    mainpara[0].classList.remove("mainPara");
    ...
    if (splitAfterDbl[0] == "<i>") {
      document.getElementsByClassName("mainPara")[0].innerHTML =
        `<span style="float: left;">` +
        "“" +
        `</span><span style="display: block;"><i>` +
        splitAfterDbl[1] +
        " " +
        splitText[1] +
        `</span>`;
    ...
    mainpara[0].classList.remove("mainPara");
    document.getElementsByClassName("mainActive")[0].innerHTML =
      `<span style="float: left;font-size: 72px;line-height: 58px;padding-top: 4px;padding-right: 8px;">` +
      splitText[0] +
      `</span>` +
      splitText[1];
    if (window.innerWidth < 575) {
      document.getElementsByClassName("mainActive")[0].innerHTML =
        `<span style="float: left;font-size: 52px;line-height: 40px;padding-top: 4px;padding-right: 8px; font-weight: normal;">` +
        splitText[0] +
        `</span>` +
        splitText[1];
    } else if (window.innerWidth > 767 && window.innerWidth < 991) {
      document.getElementsByClassName("mainActive")[0].innerHTML =
        `<span style="float: left;font-size: 70px;line-height: 55px;padding-top: 4px;padding-right: 8px; font-weight: normal;">` +
        splitText[0] +
        `</span>` +
        splitText[1];
    }
...
function shareIconHandler() {
  var parallaxControls = document
    .querySelector(".parallaxControlsStory")
    .getBoundingClientRect();
  var parallX = document.querySelector(".parallaxControlsStory");
  var articleSectionOld = [
    ...document.querySelectorAll(".paraDiv,.paraIconDiv, .richtext"),
  ]
    .filter((x) => {
      return x.scrollHeight > maxHeightParallax * 1.7;
    })
    .filter((x) => !x.classList.contains("parallaxControlsStory"))
    .map((x) => x.getBoundingClientRect());
  var articleSection = [];

  var shareOptions = document.querySelector(".shareOptions ");

  // if (ymlSalt.top <= parallaxControls.top) {
  ...
  for (let i = 0; i < articleSectionOld.length; i++) {
    articleSection.push({
      top: articleSectionOld[i].top,
      bottom: articleSectionOld[i].bottom,
    });
    for (let j = 0; j < articleSectionOld.length; j++) {
      if (articleSectionOld[i].bottom >= articleSectionOld[j].top) {
        if (i != j) {
          articleSection.push({
            top: articleSectionOld[i].top,
            bottom: articleSectionOld[j].bottom,
          });
        }
      }
    }
  ...
  for (let article of articleSection) {
    if (
      article.top <= parallaxControls.top + maxHeightParallax / 4 &&
      article.bottom >= parallaxControls.top + maxHeightParallax
    ) {
      parallX.classList.remove("notActive");
      articleCurrent = true;
...
var banners = [
  ...document.querySelectorAll(
    "section.bannerSection, section.headerFade, section.aboutUsSection"
  ),
];
(function () {
  var scrolled = false;
  ...
  nav[0].addEventListener("mouseleave", (e) => {
    if (!window.location.hash) {
      return changeNavColor(e);
    }
  });
  ...
  function init() {
    ...
    for (var i = 1; i < mainDiv.length; i++) {
      if (
        document.getElementsByClassName("sliderElem").length != 0 &&
        window
          .getComputedStyle(
            document.getElementsByClassName("sliderElem")[0],
            null
          )
        ...
        mainDiv[i].addEventListener(
          ...
          function (e) {
            if (
              Math.abs(e.changedTouches[0].clientY - touchDirY) >
              Math.abs(e.changedTouches[0].clientX - touchDirX)
            ) {
              if (
                touchDirY > e.changedTouches[0].clientY ||
                touchDirY < e.changedTouches[0].clientY
              ) {
                if (touchDirY > e.changedTouches[0].clientY) touchFlag = false;
                else touchFlag = true;
                if (
                  event.target.parentNode.classList.contains("scrollableDiv") ||
                  event.target.classList.contains("scrollableDiv")
                ) {
                  if (touchDirY > e.changedTouches[0].clientY) {
                    ...
                    if (
                      event.target.parentNode.scrollHeight -
              ...
              if (dropPar(composedPath(event.target))) {
                ...
                if (result != "false") {
                  ...
                  if (
                    self.el.getElementsByClassName("carItemParent").length == 0
                  ) {
                    swipeScroll(
                      self,
                      e.changedTouches[0],
                      document.querySelectorAll(".carItem.active")[0],
                      touchDirX
                    );
                  } else {
    ...
    document.addEventListener(
      "scroll",
      function (e) {
        if (timeoutS != undefined) clearTimeout(timeoutS);
        timeoutS = setTimeout(function () {
          if (
            document.getElementsByClassName("jw-flag-fullscreen").length == 0
          ) {
            scrollEvent(e);
          }
        }, 50);
    ...
    let sectionList = [
      ...document.querySelectorAll("section.customScroll"),
    ].filter((x) => {
      return x.scrollHeight > 0 && !x.closest(".modal-dialog");
    });
    for (let section of sectionList) {
      if (
        section.offsetTop <= position() &&
        section.offsetTop + section.scrollHeight > position()
      ) {
        nav[0].classList.add("navBackground");
      }
    }
    sectionList = [...document.querySelectorAll("section.noSlider")].filter(
      (x) => {
        return x.scrollHeight > 0 && !x.closest(".modal-dialog");
      }
    );
  ...
  function winScrollEvent(event) {
    if (event.type === "scroll") {
      ...
      for (i = 0; i < sec.length; i++) {
        let elemSec = sec[i];
        if (
          currPosition >= elemSec.offsetTop &&
          currPosition < elemSec.offsetTop + elemSec.offsetHeight
        ) {
        ...
        if (parallX) {
          if (
            pagefooter.getBoundingClientRect().top <
            parallX.offsetTop + parallX.offsetHeight
          ) {
    ...
    if (document.querySelectorAll(".modal.in").length < 1) {
      ...
      if (noSliderDiv) {
        if (-event.deltaY > 0 || event.detail < 0) {
          ...
          if (
            (anchorVal != elemList.length - 1 &&
              elemList[anchorVal + 1].offsetTop >= position() &&
              elemList[anchorVal + 1].offsetTop <
                position() + document.documentElement.clientHeight) ||
            (anchorVal != 0 &&
              elemList[anchorVal - 1].offsetTop +
                elemList[anchorVal - 1].clientHeight >=
                position() &&
              elemList[anchorVal - 1].offsetTop < position())
          ) {
            modalOpen = false;
  ...
  function arrowClickEvent(e) {
    ...
    if (elemList.length > anchorVal + 1) {
      ...
      document
        .getElementsByClassName("mainSliderElem")
        [anchorVal].classList.add("active");
      scrollTo(
        elem.offsetTop,
        e,
        document.getElementsByClassName("mainSliderElem")[anchorVal],
        1500
      );
    }
  }
  ...
  function scrollEvent(e) {
    ...
    if (isTop === 0 || isTop <= 600) {
      ...
      if (audioIcon !== "" && audioIcon !== null && audioIcon !== undefined) {
        ...
        if (
          audioIcon.parentElement.parentElement.parentElement.classList.contains(
            "marker-3"
          )
        ) {
          audioIcon.parentElement.parentElement.parentElement.classList.remove(
            "marker-3"
          );
        }
      }
      ...
      audioCtrlAll !== "" &&
      audioCtrlAll !== null &&
      audioCtrlAll !== undefined
    ) {
      if (
        window.innerHeight <
          document.querySelector(".coffExp").getBoundingClientRect().top &&
        audioIcon.classList.contains("closeSoundImg")
      ) {
        if (audioIcon) {
    ...
    if (scrollFlag) {
      ...
      for (var i = 0; i < elemL.length; i++) {
        if (
          elemL[i].offsetTop >= elemTop &&
          elemL[i].offsetTop < elemTop + document.documentElement.clientHeight
        ) {
          if (elemList[i].getElementsByClassName("scrollableDiv").length != 0) {
            var curE = elemList[i].getElementsByClassName("scrollableDiv")[0];
            if (
              curE.scrollHeight - curE.scrollTop === curE.clientHeight ||
              (lastScrollTop > window.pageYOffset && curE.scrollTop == 0)
            ) {
            ...
            if (elemList[i].classList.contains("noSlider")) {
              ...
              stopSlide(
                findSlidingElem(
                  elemL[anchorVal].getElementsByClassName("carouselDiv")
                )
              );
              stopSlide(
                findSlidingElem(elemL[i].getElementsByClassName("carouselDiv"))
              );
              animateFrame(elemL[i]);
              if (i == 0) {
                anchorVal = i;
                ...
                if (anchorVal < i) {
                  ...
                  if (
                    frompagename == "managementTeamPage" ||
                    frompagename == "aboutUsPage" ||
                    frompagename == "communityPage"
                  ) {
                    anchorVal++;
  ...
  function initParallexE() {
    if (document.getElementsByClassName("parallaxControls").length != 0) {
      if (document.getElementsByClassName("mainSliderElem").length != 0) {
        if (document.querySelector(".mainSliderElem.active")) {
          if (
            !document
              .querySelector(".mainSliderElem.active")
              .classList.contains("parallaxWrapper")
          ) {
            document
              .getElementsByClassName("parallaxControls")[0]
    ...
    for (
      var j = 0;
      j < document.getElementsByClassName("parallaxControls").length;
      j++
    ) {
      if (
        !document
          .getElementsByClassName("parallaxControls")
          [j].classList.contains("positioning")
      ) {
        var slideObj = document
          .getElementsByClassName("parallaxControls")
          [j].getElementsByClassName("pointerDiv");
        for (var i = 0; i < slideObj.length; i++) {
          slideObj[i].addEventListener("click", function (event) {
            ...
            var elem =
              elems[event.currentTarget.children[0].getAttribute("data-slide")];
            if (elem) {
              anchorVal = findElemIndex(
                elemList,
                elems[
                  event.currentTarget.children[0].getAttribute("data-slide")
                ]
              );
  ...
  function parCont() {
    var pos = position();
    var elemTop =
      document.getElementsByClassName("parallaxControls")[0].offsetTop +
      document.getElementsByClassName("parallaxControls")[0].clientHeight / 2;
    var elemL = document.getElementsByClassName("mainSliderElem");
    ...
    for (var i = elemL.length - 1; i >= 0; i--) {
      ...
      if (
        (Math.abs(elementOffset) <= elemTop &&
          activeIndex == elemL.length - 1) ||
        (elementOffset <= elemTop && activeIndex != elemL.length - 1)
      ) {
        if (activeIndex != i) {
          var pointerElemPar =
            document.getElementsByClassName("parallaxControls")[0];
              ...
              if (index != ind) {
                ...
                if (elem_shareOptions.length != 0) {
                  if (!pointerElemPar.classList.contains("notActive")) {
                    if (
                      elem_shareBtnParent[0].classList.contains("activeShare")
                    ) {
                    ...
                    if (
                      ...
                      elem_shareBtnParent[0].children[0].style.display =
                        "block";
                    }
  ...
  if (window.innerWidth > 992) {
    function changeNavColor(e) {
      ...
      for (var i = elemList.length - 1; i >= 0; i--) {
        if (
          !elemList[activeIndex].children[0].classList.contains("footer-bottom")
        ) {
        ...
        if (elementOffset == elemTop || elemTop == 0) {
          if (elemList[i].classList.contains("grayNav")) {
            ...
            if (window.innerWidth > 991) {
              ...
              var target_ul = grayMenu.getElementsByClassName(
                "nav navbar-nav pull-right customNav paddingTopNav"
              )[0];
          ...
          if (elemTop == 0) {
            if (
              !elemList[activeIndex].classList.contains("customScroll") &&
              nav[0].classList.contains("navBackground")
            ) {
              nav[0].classList.remove("navBackground");
            }
            if (
              !elemList[activeIndex].classList.contains("grayNav") &&
              nav[0].classList.contains("grayMenu")
            ) {
              nav[0].classList.remove("grayMenu");
            }
          }
        ...
        if (
          elemList[i].offsetTop <= elemTop &&
          elemList[i].offsetTop + elemList[i].scrollHeight > elemTop
        ) {
          if (elemList[i].classList.contains("grayNav")) {
            document
              .getElementsByClassName("navbar")[0]
          ...
          if (customScrollFlag && !nav[0].classList.contains("navBackground")) {
            // change added
            nav[0].classList.add("navBackground");
            nav[0].style.visibility = "visible";
      ...
      for (let banner of banners) {
        if (
          banner.offsetTop <= currPosition &&
          banner.offsetTop + banner.clientHeight > currPosition
        ) {
          if (banner.offsetTop + 40 >= currPosition) {
            ...
            nav[0].style.opacity =
              (40.0 - (currPosition - banner.offsetTop)) / 40.0;
          } else {
            nav[0].classList.remove("navSlideDown");
  ...
  function setAnimationF(elem, elemName, elemProp) {
    ...
    if (doughnutDiv && startAni) {
      var companyNameFirst = document
        .getElementById("charts")
        .getAttribute("companyNameFirst");
      var companyNameMiddle = document
        .getElementById("charts")
        .getAttribute("companyNameMiddle");
      var companyNameLast = document
        .getElementById("charts")
        .getAttribute("companyNameLast");
      var fontSizeValue;
      var companyName = "";
      if (companyNameFirst !== "") {
      ...
      if (
        document.getElementsByClassName("excelPath").length !== 0 &&
        document.getElementsByClassName("excelSheet").length !== 0
      ) {
        var xhrRequest = new XMLHttpRequest();
        var excelPath =
          document.getElementsByClassName("excelPath")[0].innerHTML;
        var excelData;
        var excelCompanies = [];
        var excelSheet =
          document.getElementsByClassName("excelSheet")[0].innerHTML;
        xhrRequest.open(
          "GET",
          "/bin/companyPieChartDataServlet?excelPath=" +
            excelPath +
            "&excelSheet=" +
            excelSheet,
          true
      ...
      overflowChart.scrollBy(
        (echart.offsetWidth - window.innerWidth) / 2 + 15,
        0
      );
    }
    if (elem) {
  ...
  function animateElem(e, flagG) {
    if (flagG != undefined) elemDir = flagG;
    else elemDir = -e.deltaY > 0 || e.detail < 0;
    if (elemDir) {
      ComunityFlagSet = false;
      if (anchorVal > 0) {
        ...
        if (
          !document
            .getElementsByClassName("mainSliderElem")
            [anchorVal - 1].classList.contains("noSlider" && "customScroll")
        ) {
          stopSlide(
            findSlidingElem(
              elemList[anchorVal].getElementsByClassName("carouselDiv")
            )
          );
          stopSlide(
            findSlidingElem(
              elemList[anchorVal - 1].getElementsByClassName("carouselDiv")
            )
          );
          var elem = elemList[--anchorVal];
          if (
          ...
          removeActive(
            document.getElementsByClassName("mainSliderElem"),
            "active"
          );
          document
            .getElementsByClassName("mainSliderElem")
  ...
  function scrollTo(to, callback, elemCur, duration) {
    //FIXME this always starts from '0', instead of the clicked element offsetTop -> This is because the position is calculated for the main <html> element, not the <iframe>'s <html> tag
    ...
    var animateScroll = function () {
      ...
      if (currentTime < duration) {
        ...
        setTimeout(function () {
          ...
          scrollFlag = true;
          if (
            elemList[anchorVal].childNodes[1].classList === undefined ||
            !elemList[anchorVal].childNodes[1].classList.contains(
              "footer-bottom"
            )
          ) {
            if (!nav[0].classList.contains("navSlideDown")) {
        ...
        if (
          elemList[anchorVal].getElementsByClassName("scrollableDiv").length !=
          0
        ) {
          modalOpen = true;
        }
...
function dropPar(elemList) {
  for (var i = 0; i < elemList.length; i++) {
    if (
      elemList[i].classList != undefined &&
      elemList[i].classList.contains("carouselDiv") &&
      !elemList[i].classList.contains("carouselFade") &&
...
function playPauseHTMLVideos(HTMLVideo) {
  if (
    (HTMLVideo.hasAttribute("desktopVideo") && window.innerWidth > 991) ||
    (HTMLVideo.hasAttribute("tabVideo") &&
      window.innerWidth < 991 &&
      window.innerWidth > 575) ||
    (HTMLVideo.hasAttribute("mobileVideo") && window.innerWidth < 575)
  ) {
    if (
      HTMLVideo.getBoundingClientRect().top < 0 &&
...
window.addEventListener("resize", function (e) {
  if (window.innerWidth > 992) {
    ...
    for (var i = 0; i < acc.length; i++) {
      ...
      if (
        acc[i].classList.contains("active") &&
        !panelList[i].classList.contains("active")
      ) {
        acc[i].classList.remove("active");
      }
    }
...
var setCount, setCardsCounts, currentPagination;
...
function openModalSpinner() {
  document.getElementsByClassName("modalGlobalSearch")[0].style.display =
    "block";
  document.getElementsByClassName("fadeGlobalSearch")[0].style.display =
    "block";
}
...
function testKeyEvent(e) {
  if (e.keyCode == 13) {
    //using Enter key press event for test purpose.
    document.activeElement.blur();
    if (verSearchIp) {
      var ip = document.getElementById("searchVerticals").value;
      var inputEl = document.getElementsByClassName("inputSearch")[0];
  ...
  window.onhashchange = function () {
    ...
    if (modalOpen) {
      ...
      for (i = 0; i < currentDiv.length; i++) {
        if (
          currentDiv[i].classList.contains("active") &&
          currentDiv[i].classList.contains("noSlider")
        ) {
          modalOpen = true;
        }
      }
    ...
    if (window.location.hash != "#/searchPanel") {
      ...
      document.body.style.overflow = "auto";
      if (
        navDiv[0].style.visibility == "hidden" ||
        !navDiv[0].style.visibility
      ) {
  ...
  searchInput.addEventListener("keydown", function (event) {
    ...
    if (event.keyCode === 13) {
      if (activeSuggest.length > 0) {
        searchInput.value = activeSuggest[0].value
          .replace(/<b>/g, "")
          .replace(/<\/b>/g, "");
      }
      localStorage.hashValue = "";
...
function searchBoxFn() {
  ...
  if (hashVal) {
    ...
    localStorage.searchValue !== "" &&
    localStorage.searchValue !== undefined &&
    localStorage.searchValue !== null
  ) {
    searchInput.value = localStorage.searchValue;
  }
  if (
    !document.URL.split("#")[1] == "/searchPanel" ||
    ...
    history.pushState(
      null,
      document.URL,
      document.URL.split("#")[0] + "#/" + "searchPanel"
    );
  }
  ...
  if (
    el.classList.contains("searchBoxIcon") ||
    localStorage.searchBar != "true"
  ) {
    document.body.style.overflow = "hidden";
    ...
    el.classList.contains("closeSearch") ||
    localStorage.searchBar != false
  ) {
    window.history.back();
    document.body.style.overflow = "auto";
...
function searchList(event) {
  ...
  inputValue = document.getElementById("searchInputG").value.toLowerCase();

  var urlPath = "/bin/solrResultServlet?searchType=suggest&searchTerm=";
  var param =
    encodeURIComponent(inputValue.replace(/[’’]/g, "'").replace(/[“”]/g, '"')) +
    "&start=0&rows=10&wt=json&template=[]";
    ...
    if (inputValue.length <= min_characters) {
      ...
      window.searchXHR.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
          ...
          var items =
            response.suggest.mySuggester[inputValue.trim()].suggestions;
...
function searchDetails(event, currentPage) {
  ...
  if (event || event.keyCode === 13) {
    ...
    if (
      ...
      searchInput.value === "" &&
      localStorage.getItem("hashValue") !== ""
    ) {
  ...
  if (isValidated) {
    ...
    if (
      ...
      displayDetails.constructor === Object
    ) {
      var details = getDisplayDetails(displayDetails.cards.count, currentPage);
      recordStartIndex = details.records.startIndex;
      recordRowCount =
        details.records.rowCount === 0 ? 1 : details.records.rowCount; // Set as minimum 1 because rowCount = 0 not handled in Solr
    }
    ...
    if (!showCardsFlag) {
      ...
      if (hashVal) {
        param =
          "" +
          encodeURIComponent(
            localStorage.searchValue.replace(/[‘’]/g, "'").replace(/[“”]/g, '"')
          ) +
          "&tags=true&start=" +
          setCount +
          "&rows=" +
...
function getDisplayDetails(cardsCount, currentPage) {
  ...
  var cardCountOnLastPage =
    cardsCount === itemsPerPage ? itemsPerPage : cardsCount % itemsPerPage;
      ...
      for (j = 0; j < parseDoc.length; j++) {
        if (parseDoc[j].hasOwnProperty("cards")) {
          ...
          for (var k = 0; k < resultList.length; k++) {
            var foundInTitle = resultList[k].title
              .toLowerCase()
          ...
          for (var j = 0; j < parseDoc.length; j++) {
            var foundInTitle = parseDoc[j].title
              .toLowerCase()
              .includes(searchInput.value.toLowerCase());
...
function cardsToHtml(cardsList, cardsToShow) {
  for (var i = cardsToShow.startIndex; i <= cardsToShow.endIndex; i++) {
    ...
    if (cardsList[i].description && cardsList[i].description.length > 0) {
      desDiv.innerHTML =
        cardsList[i].description.substring(0, 165) + " " + "...";
    ...
    if (cardsList[i].redirectLink.includes("/content/tata/en")) {
      ...
      textarea.innerHTML = cardsList[i].redirectLink.replace(
        "/content/tata/en",
        ""
      );
    }
    ...
    if (cardsList[i].twitterLink && cardsList[i].twitterLink.length != 0) {
      ...
      twitterImg.setAttribute(
        "src",
        "/etc.clientlibs/tata/clientlibs/assets/resources/img/common/globalSearch/twitterIcon.svg"
      );
      ...
      twitterImgActive.setAttribute(
        "src",
        "/etc.clientlibs/tata/clientlibs/assets/resources/img/common/globalSearch/twitterIconActive.svg"
      );
...
function openlinkCopy(e) {
  ...
  if (linkCopy.length !== 0) {
    if (
      targetElement.parentElement.classList.contains("copyDiv") &&
      !textareaOpen
    ) {
...
function searchWithTags(event) {
  ...
  if (this.id != "all") {
    ...
    for (var i = 1; i < searchCheck.length; i++) {
      ...
      if (!item.checked) selectAllTagsFlag = false;
    }
    if (selectAllTagsFlag) searchCheck[0].checked = true;
  }
...
function recordsToHtml(recordsList, recordsCountToShow) {
  ...
  for (var i = 0; i < recordsCountToShow; i++) {
    ...
    anchorUrl.innerHTML = window.location.origin + anchorUrl.value;
  ...
  function getPaginationBounds(totalPages, currentPage) {
    ...
    // More than total pages so calculate start and end pages
      ...
      // For middle pages
        ...
        if (maxPages % 2 === 0) startPage = currentPage - center;
        else startPage = currentPage - (center - 1);
...
if (document.querySelector("section.brandsSection")) {
  ...
  function loadList() {
    ...
    var pageListChecked = document.querySelectorAll(
    ...
    if (end - begin == numberPerPage) {
      if (events.slice(begin, end).length != numberPerPage) {
        ...
        var newValue = events.slice(
          events.length - numberPerPage,
          events.length
        );
        pageList = [];
        pageList = newValue;
  ...
  function loadImage(i) {
    if (
      !carItem[i].children[0].children[0].src.includes(
        carItem[i].children[0].children[0].dataset[srcDevice]
      )
    ) {
      carItem[i].children[0].children[0].src =
        carItem[i].children[0].children[0].dataset[srcDevice];
    }
    if (!carItem[i].children[0].children[0].complete) {
      ...
      if (i < carItem.length - 1) {
        carItem[i + 1].children[0].children[0].src =
          carItem[i + 1].children[0].children[0].dataset[srcDevice];
      } else {
        carItem[0].children[0].children[0].src =
          carItem[0].children[0].children[0].dataset[srcDevice];
      }
    }
  }
  setInterval(function () {
  ...
  var brandsThumbnail = document.getElementsByClassName(
    "BrandSectionIndicator"
  );
...
function bannerReload() {
  if (window.innerWidth > 991) {
    if (bannerVideoTag.hasAttribute("desktopVideo")) {
      bannerVideoTag.children[0].setAttribute(
        "src",
        bannerVideoTag.getAttribute("desktopVideo")
      );
      bannerVideoTag.setAttribute(
        "poster",
        bannerVideoTag.getAttribute("desktopPoster")
      );
      bannerVideoTag.load();
    ...
    if (bannerVideoTag.hasAttribute("tabVideo")) {
      bannerVideoTag.children[0].setAttribute(
        "src",
        bannerVideoTag.getAttribute("tabVideo")
      );
      bannerVideoTag.setAttribute(
        "poster",
        bannerVideoTag.getAttribute("tabPoster")
      );
      bannerVideoTag.load();
      bannerImage.classList.add("noDisplay");
    } else {
    ...
    if (bannerVideoTag.hasAttribute("mobileVideo")) {
      bannerVideoTag.children[0].setAttribute(
        "src",
        bannerVideoTag.getAttribute("mobileVideo")
      );
      bannerVideoTag.setAttribute(
        "poster",
        bannerVideoTag.getAttribute("mobilePoster")
      );
      bannerVideoTag.load();
      bannerImage.classList.add("noDisplay");
    } else {
...
function loadContent(event) {
  if (toggleFlag) {
    ...
    var moduleS =
      event.currentTarget.parentElement.previousElementSibling.getElementsByClassName(
        "module"
      );
    var lineS =
      event.currentTarget.parentElement.previousElementSibling.getElementsByClassName(
...
for (var i = 0; i < copyDiv.length; i++) {
  ...
  copyDiv[i].addEventListener("click", function () {
    ...
    for (var j = 0; j < copyLinkTooltip.length; j++) {
      ...
      if (
        !copyLinkTooltip[j].parentElement.children[0].classList.contains(
          "noDisplay"
        )
      ) {
        copyLinkTooltip[j].parentElement.children[0].classList.add("copyIcon");
        copyLinkTooltip[j].parentElement.children[0].classList.remove(
          "copyIconActive"
        );
      } else if (
        !copyLinkTooltip[j].parentElement.children[1].classList.contains(
          "noDisplay"
        )
      ) {
        copyLinkTooltip[j].parentElement.children[1].classList.add(
          "copyIconWhite"
        );
        copyLinkTooltip[j].parentElement.children[1].classList.remove(
          "copyIconActive"
        );
      }
    }
    ...
    function () {
      if (
        ...
        for (var j = 0; j < phoneText.length; j++) {
          if (
            !phoneText[j].classList.contains("noDisplay") &&
            !phoneText[j].classList.contains("active")
          ) {
            phoneText[j].classList.add("noDisplay");
            if (
              !phoneText[j].parentElement.children[0].classList.contains(
                "noDisplay"
              )
            ) {
              phoneText[j].parentElement.children[0].classList.add("phoneIcon");
              phoneText[j].parentElement.children[0].classList.remove(
                "phoneIconActive"
              );
            } else if (
              !phoneText[j].parentElement.children[1].classList.contains(
                "noDisplay"
              )
            ) {
              phoneText[j].parentElement.children[1].classList.add(
                "phoneIconWhite"
              );
              phoneText[j].parentElement.children[1].classList.remove(
                "phoneIconActive"
              );
            }
          } else {
    ...
    if (flagPhone) {
      for (var j = 0; j < phoneDiv.length; j++) {
        ...
        if (phoneDiv[j].children[0].classList.contains("phoneIconActive")) {
          ...
          phoneDiv[j].children[1].classList.contains("phoneIconActive")
        ) {
...
(function () {
    ...
    show: function () {
      ...
      for (var i = 0; i < fb.length; i++) {
        if (fb || twitter || linkedin || mailto) {
          ...
          twitter[i].setAttribute(
            "href",
            "https://twitter.com/share?url=" + currentUrl
          );
          linkedin[i].setAttribute(
            "href",
            "http://www.linkedin.com/shareArticle?mini=true&url=" +
              currentUrl.split("#//management-team")[0] +
              currentUrl.split("#//management-team")[1]
          );
          mailto[i].setAttribute(
            "href",
            "mailto:?Subject= Tata.com url&Body=%20" + currentUrl
  ...
  function showModal() {
      ...
      if (e.target.parentNode) {
        if (
          (e.target.classList != undefined &&
            e.target.classList.contains("openModel")) ||
          (e.target.parentNode.classList != undefined &&
            e.target.parentNode.classList.contains("openModel"))
        ) {
          ...
          xmlhttp.onreadystatechange = function (event, response) {
            if (this.readyState == 4 && this.status == 200) {
              ...
              if (
                document
                  .getElementById("modalD")
                  .getElementsByClassName("modal-dialog")[0]
                  .classList.contains("popUpModalBox")
              ) {
                document
                  .getElementById("modalD")
                  .getElementsByClassName("redirect")[0]
                  .setAttribute("href", urlRef);
              }
              if (
                document
                  .getElementById("modalD")
                  .getElementsByClassName("modal-dialog")[0]
                  .classList.contains("modalVideo")
              ) {
                ...
                for (var i = 0; i < elemListC.length; i++) {
                  ...
                  if (window.innerWidth < 992 && window.innerWidth > 767) {
                    if (
                      elemListC[i].children[0].classList.contains("jwplayer")
                    ) {
                ...
                for (
                  var i = 0;
                  i < document.getElementsByClassName("videoCarousel").length;
                  i++
                ) {
                  objs[objs.length] = new CarousalComp(
                    document.getElementsByClassName("videoCarousel")[i],
                    0
                  );
                }
              }
              ...
              var videoModalClose = document
                .getElementById("modalD")
                .getElementsByClassName("vidcloseIcon");
              for (var i = 0; i < videoModalClose.length; i++) {
                videoModalClose[i].addEventListener("click", function (e) {
                  modalN.hide();
                });
              }
              var shareBtnParent = document.querySelectorAll(
                ".shareBtnParentModal"
              )[0];
              if (shareBtnParent) {
              ...
              let firstSlide = document.querySelectorAll(
                "div.modal-dialog div.videoContainer div.innerCarousel > div.carItem"
              )[0];
              let activeSlide = document.querySelectorAll(
                "div.modal-dialog div.videoContainer div.innerCarousel > div.carItem.active"
              );
              ...
              if (this.readyState == 4 && this.status == 200) {
                ...
                if (
                  ...
                  for (var i = 0; i < elemListC.length; i++) {
                    ...
                    if (window.innerWidth < 992 && window.innerWidth > 767) {
                      var carItem =
                        document.getElementsByClassName("carItem")[0];
                      if (
                        elemListC[i].children[0].classList.contains("jwplayer")
                      ) {
    ...
    function closeSharePanel(el) {
      ...
      if (
        el.target.classList.contains("shareBtnParentModal") &&
        !sharePanelOpen
      ) {
    ...
    for (var i = 0; i < Links.length; i++) {
      if (document.URL.split("#/").length > 1) {
        if (
          Links[i].getAttribute("href").split(".html")[0] ===
  ...
  function checkModalOutsideClick(e) {
    if (modalOpen == true || window.location.hash !== "") {
      if (
        e.target.closest(".closeIcon") ||
        (!e.target.closest(".modal-dialog") &&
          !e.target.closest(".searchSection") &&
          (document.querySelectorAll(".modal-dialog").length > 0 ||
            document.getElementById("searchSection").style.display ==
              "block")) ||
        e.target.closest(".closeImg") ||
        e.target.closest(".closeTxt")
      ) {
      ...
      if (modalDialog.length !== 0) {
        var flyoutElement =
            document.getElementsByClassName("modal-dialog")[0].parentElement,
        ...
        if (
          (targetElement == flyoutElement || targetElement == flyoutElement1) &&
          document
            .getElementById("modalD")
            .getElementsByClassName("jw-orientation-portrait").length == 0
        ) {
          var currentDiv = document.getElementsByTagName("section");
          var modalOverlay = document.getElementById("modalOverlay");
          if (modalOverlay.classList.contains("overlaySection")) {
          ...
          if (
            targetElement.parentElement.classList.contains("linkCopyModal") &&
            !textareaOpen
          ) {
            copyUrlModal();
            textareaOpen = false;
          } else if (
            targetElement.parentElement.classList.contains("copyBtnModal") &&
            !textareaOpen
          ) {
            copyAllFunction();
            textareaOpen = false;
            ...
            if (copyAll.length !== 0) {
              var urlCopiedall =
                copyAll[0].nextElementSibling.nextElementSibling.children[0];
            ...
            if (linkCopy.length !== 0) {
              var urlCopied =
                linkCopy[0].nextElementSibling.nextElementSibling.children[0];
              urlCopied.style.display = "none";
  ...
  if (xhttp.status === 200) {
    ...
    if (revenueCards) {
      for (i = 0; i < res.investorStockData.length; i++) {
        ...
        if (
          document.querySelectorAll(
            ".C" + res.investorStockData[i].co_code + " .bse span"
          )[0]
        ) {
          document.querySelectorAll(
            ".C" + res.investorStockData[i].co_code + " .bse span"
          )[0].innerHTML = res.investorStockData[i].BSEPrice;
        }
        if (
          document.querySelectorAll(
            ".C" + res.investorStockData[i].co_code + " .nse span"
          )[0]
        ) {
          document.querySelectorAll(
            ".C" + res.investorStockData[i].co_code + " .nse span"
          )[0].innerHTML = res.investorStockData[i].NSEPrice;
        }
        ...
        if (BSEPerChange < 0) {
          if (
            document.querySelector(
              ".C" + res.investorStockData[i].co_code + " .bse"
            )
          ) {
            document
              .querySelector(".C" + res.investorStockData[i].co_code + " .bse")
              .classList.add("neg");
          }
        ...
        if (NSEPerChange < 0) {
          if (
            document.querySelector(
              ".C" + res.investorStockData[i].co_code + " .nse"
            )
          ) {
            document
              .querySelector(".C" + res.investorStockData[i].co_code + " .nse")
              .classList.add("neg");
          }
